...
from .api_views import RegisterView, MeView, ChangePasswordView, PendingUsersView, ApproveUserView, UsersListView, UserManageView, NursesView
...
urlpatterns = [
    ...
    path('nurses/',             NursesView.as_view(),         name='auth-nurses'),
